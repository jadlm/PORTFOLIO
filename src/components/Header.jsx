export default function Header() {
    return (
        <div id="top" className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
            ...
            <h1 className="text-3xl sm:text-6xl lg:text-[66px] font-Ovo">Full Stack Web Developer based in Morocco.</h1>
            <p className="max-w-2xl mx-auto font-Ovo">Full Stack Developer passionate about building scalable and responsive web applications. I specialize in creating modern, user-friendly digital solutions using cutting-edge technologies.</p>
