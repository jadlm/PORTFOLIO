        ...
        >
            ...
            <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
                ...
                >
                    ...
                    <ul className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl px-4 sm:px-0">
                        {data.map((item, index) => (
                            <motion.li 
                                ...
                                key={item.name} 
                                className="border border-gray-300 dark:border-white/30 rounded-xl p-4 sm:p-6 cursor-pointer hover:bg-lightHover duration-500 hover:shadow-black dark:hover:shadow-white/20 dark:hover:bg-darkHover/50"
                            >
                                <img src={item.icon1} alt="" className="w-6 sm:w-7 mt-3 dark:hidden" />
                                <img src={item.icon2} alt="" className="w-6 sm:w-7 mt-3 hidden dark:block" />
                                <h3 className="my-3 font-semibold text-gray-700 dark:text-white text-xs sm:text-sm">{item.name}</h3>
                                <p className="text-gray-600 text-[9px] sm:text-[10px] leading-relaxed dark:text-white/80">{item.description}</p>
                            </motion.li>
                        ))}
                    </ul>
